if (ffbrowser.isIE8 === true) {
    /**
    A polyfill used for IE8. It is loaded conditionally by Require.js and Modernizr<br>
    ...
    @deprecated plugins/
    @class selectivizr.js
    **/

    /**
    * This module contains global methods for recognizing selectors on IE8
    * @module Polyfills
    */
    ...
    */
    ...
    (function (win) {
        ...
        /**
         * Description
         * @method normalizeSelectorWhitespace
         * @param {} selectorText
         * @return CallExpression
         */
