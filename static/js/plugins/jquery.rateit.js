...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (!itemdata('init')) {
                ...
                if (itemdata('backingfld')) {
                    ...
                    var fld = $(itemdata('backingfld')).css('visibility', 'hidden');
    ...
    //some default values.
    $.fn.rateit.defaults = { min: 0, max: 5, step: 0.5, starwidth: 31, starheight: 16, readonly: false, resetable: true, ispreset: false };
